...
import de.awagen.kolibri.definitions.processing.modifiers.ParameterValuesDefinitionSpec._
...
import de.awagen.kolibri.definitions.usecase.searchopt.jobdefinitions.parts.BatchGenerators
