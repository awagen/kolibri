...
import de.awagen.kolibri.definitions.usecase.searchopt.metrics.IRMetricFunctions.NO_JUDGEMENTS
import de.awagen.kolibri.definitions.utils.JudgementInfoTestHelper.judgementsToSuccessJudgementInfo
