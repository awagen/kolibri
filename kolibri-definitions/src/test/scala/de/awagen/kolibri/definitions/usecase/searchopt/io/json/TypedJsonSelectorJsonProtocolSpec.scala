...
import de.awagen.kolibri.definitions.usecase.searchopt.io.json.TypedJsonSelectorJsonProtocol._
import de.awagen.kolibri.definitions.usecase.searchopt.parse.TypedJsonSelectors.TypedJsonSeqSelector
