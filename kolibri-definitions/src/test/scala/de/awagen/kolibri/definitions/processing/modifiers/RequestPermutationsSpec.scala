...
import de.awagen.kolibri.definitions.processing.modifiers.ModifierMappers.{BaseBodyMapper, BaseHeadersMapper, BaseParamsMapper}
import de.awagen.kolibri.definitions.processing.modifiers.RequestPermutations.MappingModifier
