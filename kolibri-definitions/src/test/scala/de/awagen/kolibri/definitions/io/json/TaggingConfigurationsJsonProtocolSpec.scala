...
import de.awagen.kolibri.definitions.io.json.TaggingConfigurationsJsonProtocol.{MapKeyTaggerFuncFormat, MetricRowTaggerFuncFormat, RequestTemplateTaggerFuncFormat, taggingConfigurationJsonFormat}
