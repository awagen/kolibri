...
import de.awagen.kolibri.definitions.processing.TestTaskHelper.{concatIdsTask, productIdResult}
import de.awagen.kolibri.definitions.processing.execution
import de.awagen.kolibri.definitions.processing.failure.TaskFailType.{NotYetStartedTask, TaskFailType}
import de.awagen.kolibri.definitions.testclasses.UnitTestSpec
import de.awagen.kolibri.definitions.utils.TestHelper._
