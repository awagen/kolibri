...
import de.awagen.kolibri.definitions.processing.TestTaskHelper.productIdResult
import de.awagen.kolibri.definitions.processing.execution.task.TaskStates.{Running, TaskState}
