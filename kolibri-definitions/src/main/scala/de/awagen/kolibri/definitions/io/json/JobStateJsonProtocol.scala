...
import de.awagen.kolibri.definitions.io.json.EnumerationJsonProtocol.processingResultFormat
import de.awagen.kolibri.definitions.processing.ProcessingMessages.{JobStatusInfo, ResultSummary}
