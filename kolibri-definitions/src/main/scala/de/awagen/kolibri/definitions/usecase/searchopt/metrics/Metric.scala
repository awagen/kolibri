...
import de.awagen.kolibri.definitions.io.json.MetricFunctionJsonProtocol
import de.awagen.kolibri.definitions.io.json.MetricFunctionJsonProtocol.MetricFunction
