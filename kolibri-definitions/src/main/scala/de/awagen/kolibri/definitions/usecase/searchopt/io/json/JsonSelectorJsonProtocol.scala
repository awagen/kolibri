...
import de.awagen.kolibri.definitions.usecase.searchopt.parse.JsonSelectors
import de.awagen.kolibri.definitions.usecase.searchopt.parse.JsonSelectors.JsonSelectorPathRegularExpressions.{anyValidSelectorRegex, recursiveAndPlainSelectorKeysToSelector, recursiveAndRecursiveSelectorKeysToSelector}
