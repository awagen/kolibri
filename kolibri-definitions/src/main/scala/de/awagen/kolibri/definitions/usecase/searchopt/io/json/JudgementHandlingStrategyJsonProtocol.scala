...
import de.awagen.kolibri.definitions.usecase.searchopt.io.json.EnumerationJsonProtocol._
import de.awagen.kolibri.definitions.usecase.searchopt.metrics.JudgementHandlingStrategy
