...
coverageExcludedPackages := "de\\.awagen\\.kolibri\\.definitions\\.config\\..*;" +
  "de\\.awagen\\.kolibri\\.definitions\\.processing\\.ProcessingMessages;" +
  "de\\.awagen\\.kolibri\\.definitions\\.processing\\.JobPartIdentifiers;" +
  "de\\.awagen\\.kolibri\\.definitions\\.exceptions\\..*;" +
  "de\\.awagen\\.kolibri\\.definitions\\.traits\\.Traits;" +
  "de\\.awagen\\.kolibri\\.definitions\\.usecase\\.searchopt\\.domain\\..*;" +
  "de\\.awagen\\.kolibri\\.definitions\\.usecase\\.searchopt\\.parse\\.ParsingConfig;"
...
assemblyJarName in assembly := s"kolibri-definitions.${version.value}.jar" //jar name
...
description := "kolibri-definitions provides shared abstractions for the definition of computation for the the kolibri project. " +
