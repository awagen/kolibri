...
object ParameterValues {
  ...
  case class ParameterValues(name: String,
                             ...
                             values: IndexedGenerator[String]) extends IndexedGenerator[ParameterValue] {
   ...
   *
   */
  class ParameterValueMapping(private[this] var values: ParameterValues,
                              private[this] val mappedValues: Seq[MappedParameterValues],
                              private[this] val mappingKeyValueAssignments: Seq[(Int, Int)]) extends IndexedGenerator[Seq[ParameterValue]] {
    values = removeTopLevelKeysWithMissingMappings(values)
