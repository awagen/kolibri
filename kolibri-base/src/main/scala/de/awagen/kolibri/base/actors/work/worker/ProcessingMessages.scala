...
import de.awagen.kolibri.base.actors.work.worker.ProcessingMessages.KeyEnum.TypedKey
...
object ProcessingMessages {
  ...
  object KeyEnum extends Enumeration {
    type KeyEnum = TypedKey[_]

    case class TypedKey[+T](name: String, castFunction: Any => T) extends super.Val

    val JOB_ACTOR_CONFIG: TypedKey[JobActorConfig] = TypedKey("jobActorConfig", x => x.asInstanceOf[JobActorConfig])
  }
