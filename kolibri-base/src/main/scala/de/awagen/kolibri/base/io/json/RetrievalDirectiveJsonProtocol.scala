...
import de.awagen.kolibri.base.directives.RetrievalDirective.{RetrievalDirective, Retrieve}
import de.awagen.kolibri.base.io.json.EnumerationJsonProtocol.resourceTypeMapStringGeneratorStringFormat
