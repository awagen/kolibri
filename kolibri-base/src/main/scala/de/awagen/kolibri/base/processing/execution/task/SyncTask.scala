...
import de.awagen.kolibri.base.processing.execution.task.TaskStates.{Done, TaskState}
import de.awagen.kolibri.base.processing.failure.TaskFailType.{MissingPrerequisites, TaskFailType}
