...
object QueuedRunnableRepository extends AtomicMapPromiseStore[String, (SourceQueueWithComplete[IndexedGenerator[(Any, Option[ActorRef])]], (UniqueKillSwitch, Future[Done])), String] {
  ...
  override def retrievalObjectToKeyFunc: String => String = identity
}
