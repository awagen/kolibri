...
package de.awagen.kolibri.fleet.akka.cluster
...
import de.awagen.kolibri.fleet.akka.cluster.ClusterNodeObj.LOCAL_RESOURCES_ACTOR_NAME
...
import de.awagen.kolibri.fleet.akka.http.server.routes.JobDefRoutes.getSearchEvaluationEndpointAndJobDef
