...
import de.awagen.kolibri.fleet.akka.config.di.modules.Modules.HttpConnectionPoolDIModule
import de.awagen.kolibri.fleet.akka.config.di.modules.connections.HttpModule.logger
