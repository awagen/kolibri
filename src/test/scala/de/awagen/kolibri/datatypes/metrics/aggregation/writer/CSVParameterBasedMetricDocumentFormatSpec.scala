...
class CSVParameterBasedMetricDocumentFormatSpec extends UnitTestSpec {
  ...
  "CSVParameterBasedMetricDocumentFormat" should {
    ...
    "correctly give formatted representation of the aggregation for single rows" in {
      ...
      row1 mustBe "v1_1\tv1_2\t0.0\t\t1.0\t0.2000\t0.0\t\t1.0\t0.4000"
      header2 mustBe expectedHeader2
      row2 mustBe "v2_1\tv2_2\t0.0\t\t1.0\t0.1000"
      header3 mustBe expectedHeader3
      row3 mustBe "v3_1\tv3_2\t0.0\t\t1.0\t0.3000"
    }
    ...
    "correctly give formatted representation of the aggregation for full document" in {
      ...
      val expectedRow1 = "v1_1\tv1_2\t\t0.0\t\t1.0\t0.2000\t0.0\t\t1.0\t0.4000\t0.0\t\t0.0\t0.0000\t0.0\t\t0.0\t0.0000"
      val expectedRow2 = "v2_1\tv2_2\t\t0.0\t\t0.0\t0.0000\t0.0\t\t0.0\t0.0000\t0.0\t\t1.0\t0.1000\t0.0\t\t0.0\t0.0000"
      val expectedRow3 = "v3_1\t\tv3_2\t0.0\t\t0.0\t0.0000\t0.0\t\t0.0\t0.0000\t0.0\t\t0.0\t0.0000\t0.0\t\t1.0\t0.3000"
