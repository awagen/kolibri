...
object FileReaderUtils extends DefaultJsonProtocol {
   ...
   * @return
   */
  def extractFilePrefixToLineValuesMapping(fileReader: Reader[String, Seq[String]],
                                           directoryReader: DataOverviewReader,
                                           directory: String,
                                           filesSuffix: String,
                                           directorySeparator: String = "/"): Map[String, Seq[String]] = {
